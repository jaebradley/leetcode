...
class Solution:
    """
    Feels like range query.
    Left-most.
    Keep track of max fruit size and count of fruit indices <= max fruit size
    Keep track of max basket size and count of basket indices <= max basket size
    Once there's a difference.
    Sort both arrays and find first index where fruits > baskets>
    """
